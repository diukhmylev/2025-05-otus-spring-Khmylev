...
class CommentRepositoryTest extends AbstractRepositoryTestData {
    ...
    void shouldSaveComment() {
        Comment newComment = new Comment(null, "New comment", Instant.now(), dbBooks.get(0));
    ...
    void shouldReturnCommentsByBookId() {
        ...
        assertThat(actualTexts).containsExactlyInAnyOrderElementsOf(expectedTexts);
    }
}
