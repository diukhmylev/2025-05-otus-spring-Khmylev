...
public class CommentController {
    ...
    public String listByBook(@PathVariable String bookId, Model model) {
    ...
    public String addComment(@PathVariable String bookId, @ModelAttribute CommentDto commentDto) {
    ...
    public String saveEdit(@PathVariable String id, @ModelAttribute CommentDto commentDto) {
